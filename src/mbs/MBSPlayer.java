		...
		if (OSValidator.isWindows()) {
			...
			if (state == false) {
				...
				try {
					...
					if (otherPid == 0) {
						otherPid = mp3Pid2;
						System.out.println("Ýlk other Pid:" + mp3Pid);

					}
					System.out.println("Ýlk play Pid:" + mp3Pid);
